  ...
  return (
    <footer className="bg-pink-300 text-black py-8">
      <div className="container mx-auto text-center">
        <div className="mb-4">
          <h3 className="text-xl font-semibold">SmartKart</h3>
        ...
        <div className="mb-4">
          ...
          <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="mx-2 text-lg">
            <i className="fab fa-twitter">x</i>
          </a>
          <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer" className="mx-2 text-lg hover:text-pink-600">
            <i className="fab fa-instagram">instagram</i>
          </a>
        </div>

        <div className="text-sm">
          <p>&copy; {new Date().getFullYear()} SmartKart. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
